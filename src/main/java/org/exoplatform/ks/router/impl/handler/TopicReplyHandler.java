 ...
 * Apr 24, 2012  
 */
public class TopicReplyHandler extends BaseEventHandler {

  @Override
  public void handle(BaseEvent event) throws HandleException {
    System.out.println("TopicReplyHandler::" + event.toString() + "::arguments[TopicID = " + event.getArgs().get("topicID") + "]");
  }
