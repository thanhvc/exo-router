 ...
 * Apr 24, 2012  
 */
public class SearchForumHandler extends BaseEventHandler {
  @Override
  public void handle(BaseEvent event) throws HandleException {
    System.out.println("SearchForumHandler::" + event.toString() + "::arguments[pageID = " + event.getArgs().get("pageID") + "]");
  }
}
