 ...
 * Apr 24, 2012  
 */
public class CategoryShowHandler extends BaseEventHandler {

  @Override
  public void handle(BaseEvent event) throws HandleException {
    System.out.println("CategoryShowHandler::" + event.toString() + "::with::CategoryID = " + event.getArgs().get("categoryID"));
  }
