 ...
 * Apr 24, 2012  
 */
public class TopicQuoteHandler extends BaseEventHandler {

  @Override
  public void handle(BaseEvent event) throws HandleException {
    System.out.println("TopicQuoteHandler::" + event.toString() + "::arguments[TopicID = " + event.getArgs().get("topicID") + "]");
   }
