 ...
 * Apr 24, 2012  
 */
public class TopicPostShowHandler extends BaseEventHandler {
  @Override
  public void handle(BaseEvent event) throws HandleException {
    System.out.println("TopicPostShowHandler::" + event.toString() + "::arguments[topicID = " + event.getArgs().get("topicID") + ", postID = " + event.getArgs().get("postID") + "]");
  }
}
